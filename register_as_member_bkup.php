        ...
        if($password == $confirmPassword){
            ...
            if($check == 0){
                ...
                try{
                    ...
                    $mail->setFrom('jumbehrstudygroup.org');
                    $mail->addAddress($email,$name);
                    $mail->Subject = 'Please verify email';
                    $mail->isHTML(true);
                    $mail->Body = "Please click on the link below to confirm your registration to JUMBEHRSTUDYGROUP<br><br>
                    <a href='http://jumbehrstudygroup.org/confirm_job_seeker.php?email=$email&token=$token'>Click here</a>
                    ";
                    if($mail->send()){
